                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 border-2 border-slate-300 rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-600 text-slate-900 placeholder:text-slate-400"
                                    disabled={loading}
                                />
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-4 py-3 border-2 border-slate-300 rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-600 text-slate-900"
                                        disabled={loading}
                                    >
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={5}
                                    className="w-full px-4 py-3 border-2 border-slate-300 rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-600 text-slate-900 placeholder:text-slate-400 resize-none"
                                    disabled={loading}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="G..."
                                    className="w-full px-4 py-3 border-2 border-slate-300 rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-600 text-slate-900 placeholder:text-slate-400 font-mono text-sm"
                                    disabled={loading}
                                />
                            </div>
                                    ...
                                    <div className="flex gap-2">
                                        {[1, 2, 3, 4].map(num => (
                                            <button
                                                ...
                                                disabled={loading}
                                                className={`flex-1 py-3 rounded-full font-semibold transition-all duration-200 ${milestones === num
                            ...
                            <div className="flex gap-3 pt-4">
                                <button
                                    onClick={onClose}
                                    disabled={loading}
                                    className="flex-1 py-3 px-6 border-2 border-slate-300 rounded-full font-semibold text-slate-700 hover:bg-slate-50 transition-all duration-200 disabled:opacity-50"
                                >
                                    Cancel
                                </button>
                                <button
                                    ...
                                    className="flex-1 py-3 px-6 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg"
                                >
